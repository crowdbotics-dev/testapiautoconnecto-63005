...
## Project Structure
    ...
    ├── testapiautoconnecto_63005  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_63005`
...
2. Clone this repo and `cd testapiautoconnecto_63005`
